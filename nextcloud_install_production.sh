...
choice=$(whiptail --title "$TITLE - Choose disk format" --nocancel --menu "How would you like to configure your disks?\n$MENU_GUIDE" "$WT_HEIGHT" "$WT_WIDTH" 4 \
...
while :
do
    choice=$(whiptail --title "$TITLE - Set DNS Resolver" --menu "Which DNS provider should this Nextcloud box use?\n$MENU_GUIDE" "$WT_HEIGHT" "$WT_WIDTH" 4 \
