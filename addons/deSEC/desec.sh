...
then
    ...
    curl_to_dir "https://raw.githubusercontent.com/nextcloud/vm/ubuntu2204/addons/deSEC" "hook.sh" "$SCRIPTS"/deSEC
    chmod +x "$SCRIPTS"/deSEC/hook.sh
    curl_to_dir "https://raw.githubusercontent.com/nextcloud/vm/ubuntu2204/addons/deSEC" ".dedynauth" "$SCRIPTS"/deSEC
