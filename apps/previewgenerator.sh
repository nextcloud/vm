...
then
    ...
    # Memory tuning
    sed -i 's|policy domain="resource" name="memory" value=.*|policy domain="resource" name="memory" value="1024MiB"|g' /etc/ImageMagick-6/policy.xml
    sed -i 's|policy domain="resource" name="map" value=.*|policy domain="resource" name="map" value="2048MiB"|g' /etc/ImageMagick-6/policy.xml
    sed -i 's|policy domain="resource" name="area" value=.*|policy domain="resource" name="area" value="512MiB"|g' /etc/ImageMagick-6/policy.xml
