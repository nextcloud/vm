...
Please note, that this will need around 1KB per folder in this external storage.
We will set the max folder variable to 524288 which will be around 500 MB if you have so many folders.
If you have more, you will need to raise this value manually inside '/etc/sysctl.conf'.
