...
then
    if ! curl -sfL https://raw.githubusercontent.com/nextcloud/vm/24.04-LTS/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/nextcloud/vm/24.04-LTS/lib.sh -o /var/scripts/lib.sh
fi
