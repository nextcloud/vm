...
then
    if ! curl -sfL https://raw.githubusercontent.com/nextcloud/vm/docker-postgresql/lib.sh -o /var/scripts/lib.sh
    then
...
then
    ...
    curl -sfL https://raw.githubusercontent.com/nextcloud/vm/docker-postgresql/lib.sh -o /var/scripts/lib.sh
fi
