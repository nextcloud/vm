...
then
    if ! curl -sfL https://raw.githubusercontent.com/nextcloud/vm/UBUNTU-22.04/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/nextcloud/vm/UBUNTU-22.04/lib.sh -o /var/scripts/lib.sh
fi
