...
High-Performance backend for Nextcloud Talk, Whiteboard for Nextcloud, Extract for Nextcloud, Vaultwarden/Bitwarden RS, Pi-hole, PiVPN, \
Plex Media Server, Previewgenerator, Remotedesktop and Midnight Commander.\n
Note:
Vaultwarden/Bitwarden RS and Plex Media Server files were restored (if they were installed before) but the containers need to get \
